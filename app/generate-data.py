...
def generate_response(label):
    ...
    if label == "certificates":
        return [
            "I earned a Document Tracking Assistant Certificate for creating an effective system to manage and track documents for the Province of Southern Leyte. I also received an Enablement Certificate for joining the ASEAN Data Science Explorers 2023 and completing SAP Analytics Cloud training. I hold a Data Analysis with Python Certificate where I learned to handle data from CSVs and SQL, using Numpy, Pandas, Matplotlib, and Seaborn to process and visualize information. I finished the Scientific Computing with Python Certificate, building solid skills in algorithms, data structures, OOP, and advanced Python computation. I achieved the JavaScript Algorithms and Data Structures Certificate, gaining practical experience in core JS, OOP, functional programming, algorithms, and APIs. I completed the Front End Development Libraries Certificate by building real projects with Bootstrap, jQuery, Sass, React, and Redux. I was awarded the Data Visualization Certificate for designing charts, graphs, and maps using D3.js and working with JSON and APIs. I also earned the Relational Database Certificate, covering Bash, PostgreSQL with SQL, scripting, and Git version control. Finally, I finished the Responsive Web Design Certificate, learning modern HTML and CSS techniques for building responsive, user-friendly sites.",
            "I have a Document Tracking Assistant Certificate for developing a document monitoring system for the Province of Southern Leyte, along with an Enablement Certificate earned through my participation in the ASEAN Data Science Explorers 2023, which included SAP Analytics Cloud training. My Data Analysis with Python Certificate taught me to pull and analyze data from CSV files and SQL using tools like Numpy, Pandas, Matplotlib, and Seaborn. I further strengthened my skills through the Scientific Computing with Python Certificate, which covered OOP, algorithms, and advanced calculations. I hold a JavaScript Algorithms and Data Structures Certificate that deepened my understanding of JavaScript fundamentals, functional programming, and APIs. I earned the Front End Development Libraries Certificate by creating projects with Bootstrap, jQuery, Sass, React, and Redux. I received a Data Visualization Certificate for building visualizations with D3.js and working with JSON and APIs. I also have a Relational Database Certificate where I learned Bash, PostgreSQL, scripting, and Git version control. Lastly, I completed the Responsive Web Design Certificate, developing sites with modern HTML and CSS that adapt to all screens.",
            "I obtained a Document Tracking Assistant Certificate after developing a streamlined system for tracking documents for the Province of Southern Leyte. I also gained an Enablement Certificate by participating in the ASEAN Data Science Explorers 2023 and training with SAP Analytics Cloud. I hold a Data Analysis with Python Certificate that taught me to work with CSVs, SQL, and data libraries like Numpy, Pandas, Matplotlib, and Seaborn for data cleaning and visualization. Completing the Scientific Computing with Python Certificate helped me improve my Python skills in data structures, algorithms, and OOP. I have a JavaScript Algorithms and Data Structures Certificate, which strengthened my skills in core JavaScript, OOP, functional programming, and working with APIs. I finished the Front End Development Libraries Certificate by building projects using Bootstrap, jQuery, Sass, React, and Redux. The Data Visualization Certificate trained me to create data visuals with D3.js, handle JSON, and use APIs. I earned a Relational Database Certificate where I practiced Bash, SQL with PostgreSQL, scripting, and Git version control. To round it off, I completed the Responsive Web Design Certificate, applying modern HTML and CSS to build fully responsive websites.",
            "I was awarded a Document Tracking Assistant Certificate for building a document tracking solution for the Province of Southern Leyte. In addition, I received an Enablement Certificate for taking part in the ASEAN Data Science Explorers 2023 and completing SAP Analytics Cloud training. I hold a Data Analysis with Python Certificate where I learned to extract and process data from CSV and SQL sources, and mastered Numpy, Pandas, Matplotlib, and Seaborn. My Scientific Computing with Python Certificate gave me a solid grounding in algorithms, data structures, object-oriented programming, and complex computations. I also earned the JavaScript Algorithms and Data Structures Certificate by studying JavaScript fundamentals, OOP, functional programming, algorithms, and APIs. I completed the Front End Development Libraries Certificate through real-world projects using Bootstrap, jQuery, Sass, React, and Redux. I was granted the Data Visualization Certificate for producing data charts and maps with D3.js and working with JSON and APIs. Additionally, my Relational Database Certificate strengthened my skills in Bash, PostgreSQL, scripting, and Git. To top it off, I finished the Responsive Web Design Certificate by mastering HTML and CSS to build adaptable, user-friendly websites.",
            "I received a Document Tracking Assistant Certificate for designing a system that tracks and manages documents for the Province of Southern Leyte. I also earned an Enablement Certificate through my participation in the ASEAN Data Science Explorers 2023 and an SAP Analytics Cloud session. My Data Analysis with Python Certificate trained me to use CSVs, SQL, and tools like Numpy, Pandas, Matplotlib, and Seaborn for analysis and visualization. I expanded my knowledge further with the Scientific Computing with Python Certificate, which covered OOP, data structures, and algorithm design. I gained my JavaScript Algorithms and Data Structures Certificate by learning core JavaScript concepts, functional programming, algorithms, and APIs. I completed the Front End Development Libraries Certificate with projects using Bootstrap, jQuery, Sass, React, and Redux. My Data Visualization Certificate shows my ability to use D3.js, handle JSON, and connect with APIs. I hold a Relational Database Certificate where I worked with Bash, PostgreSQL, scripting, and Git. Finally, I achieved the Responsive Web Design Certificate by building websites with HTML and CSS that work seamlessly on all devices.",
            "I secured a Document Tracking Assistant Certificate for implementing a tracking solution for the Province of Southern Leyte's documents. I was also awarded an Enablement Certificate after taking part in the ASEAN Data Science Explorers 2023 and completing SAP Analytics Cloud training. I have a Data Analysis with Python Certificate, which covered reading CSVs and SQL data and using libraries like Numpy, Pandas, Matplotlib, and Seaborn to analyze and present data. I strengthened my coding foundation with the Scientific Computing with Python Certificate, which focused on algorithms, OOP, and complex Python calculations. I earned the JavaScript Algorithms and Data Structures Certificate by studying core JavaScript, functional programming, algorithms, and working with APIs. I gained the Front End Development Libraries Certificate by building real projects with Bootstrap, jQuery, Sass, React, and Redux. I achieved the Data Visualization Certificate for producing visual data stories with D3.js and working with JSON and APIs. My Relational Database Certificate equipped me with skills in Bash, PostgreSQL, scripting, and Git version control. Lastly, I completed the Responsive Web Design Certificate, building modern, responsive sites using HTML and CSS."
        ]
...
questions = {
    "certificates": [
        ...
        "can you tell me about your certificates",
